defmodule FootballResults.DataTest do
  ...
  describe "matches" do
    ...
    @valid_attrs %{ateam: "some ateam", division: "some division", ftag: 42, fthg: 42, ftr: 42, htag: 42, hteam: "some hteam", hthg: 42, htr: 42, season: 42}
    @update_attrs %{ateam: "some updated ateam", division: "some updated division", ftag: 43, fthg: 43, ftr: 43, htag: 43, hteam: "some updated hteam", hthg: 43, htr: 43, season: 43}
